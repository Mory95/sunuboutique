                    ...
                    <div class="card mb-4 shadow-sm">
                        ...
                        <div class="card-body" >
                                   {{--  @foreach ($p->categories as $item)
                                        <strong class="d-inline-block mb-2">{{ $item->nom_categorie }}</strong>
                                        @endforeach --}}
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-sm btn-outline-secondary">
                                                    <a href="{{ route('produit.show', $p->id) }}" class=" stretched-link" style="text-decoration: none;">
                                                        Voire produitss
                                                    </a>
                                                </button>
                                                <button type="button" class="btn btn-sm btn btn-primary ml-2">
                                                    <a href="{{ route('cart.store', $p->id ) }}"class="stretched-link" style="text-decoration: none;">
                                                        Ajouter au panier
                                                    </a>
                                                </button>
                                            </div>
